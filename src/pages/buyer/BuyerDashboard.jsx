...
// import { ShoppingCart, CreditCard, Shield, Eye, Download, Filter, Search, Bell, Settings, Globe, Zap, Target, Award, Activity, BarChart3, Camera, Star, Bookmark, Share2, RefreshCw, Mail, Phone, Map, TrendingUp, Users, Leaf, DollarSign, MapPin, Calendar, CheckCircle, Clock, AlertCircle, Plus, Minus, Heart, ShoppingBag, Wallet, ArrowUpDown, BarChart2, PieChart as PieChartIcon, Database, FileText, ChevronDown, ExternalLink, QrCode, Lock, Unlock, Coins, Sparkles } from 'lucide-react';
...
//   const portfolioData = [
//     { project: 'Mangrove', credits: 5000, value: 225000, growth: 12.5, color: '#10b981' },
//     { project: 'Seagrass', credits: 3200, value: 144000, growth: 8.3, color: '#3b82f6' },
//     { project: 'Wetland', credits: 1800, value: 81000, growth: 15.2, color: '#8b5cf6' },
//     { project: 'Kelp', credits: 1200, value: 54000, growth: 6.7, color: '#f59e0b' }
//   ];
...
//             </div>
//           </div>
//           <p className="text-3xl font-bold text-emerald-400 mb-2">${(Object.values(realTimePrices)[0] || 48.75).toFixed(2)}</p>
//           <p className="text-gray-300">Average Credit Price</p>
//         </div>

//         <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-xl p-6 border border-blue-500/30">
//           <h3 className="text-xl font-bold text-white mb-4">Trading Volume</h3>
//           <p className="text-3xl font-bold text-blue-400 mb-2">24.5K</p>
//           <p className="text-gray-300">Credits Traded Today</p>
//         </div>
...
//           <p className="text-gray-300">+8.2% this week</p>
//         </div>
//       </div>
...
//           <h2 className="text-2xl font-bold text-white">Available Carbon Credits</h2>
...
//             <div className="flex items-center space-x-2">
//               <span className="text-gray-400 text-sm">Price: ${priceRange[0]} - ${priceRange[1]}</span>
//               <input
//                 type="range"
//                 min="40"
//                 max="60"
...
//           <div key={credit.id} className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 hover:bg-gray-800/70 transition-all duration-300 hover:scale-105 cursor-pointer group">
...
//                   </h3>
//                   {credit.verified && <Shield className="h-4 w-4 text-emerald-400" />}
//                 </div>
//                 <p className="text-gray-400 mb-2">{credit.location}</p>
...
//                 <p className="text-emerald-400 text-lg font-bold">${credit.price}</p>
//                 <p className="text-gray-400 text-xs">Per Credit</p>
//               </div>
//               <div className="bg-blue-600/10 rounded-lg p-3">
//                 <p className="text-blue-400 text-lg font-bold">{credit.available.toLocaleString()}</p>
...
//                 <p className="text-white font-semibold">{credit.impact.co2}t</p>
//                 <p className="text-gray-500 text-xs">CO2</p>
//               </div>
//               <div className="text-center">
//                 <p className="text-white font-semibold">{credit.impact.biodiversity}%</p>
//                 <p className="text-gray-500 text-xs">Biodiversity</p>
//               </div>
//               <div className="text-center">
//                 <p className="text-white font-semibold">{credit.impact.community}%</p>
...
//                 className="flex-1 flex items-center justify-center space-x-2 px-4 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg transition-colors"
//               >
...
//             <YAxis stroke="#9CA3AF" />
//             <Tooltip />
//             <Area type="monotone" dataKey="demand" fill="#8b5cf6" stroke="#8b5cf6" fillOpacity={0.3} />
//             <Bar dataKey="volume" fill="#3b82f6" opacity={0.8} />
//             <Line type="monotone" dataKey="price" stroke="#10b981" strokeWidth={3} dot={{ fill: '#10b981' }} />
//           </ComposedChart>
//         </ResponsiveContainer>
//       </div>
//     </div>
...
//               <p className="text-emerald-400">Real-time valuation</p>
//             </div>
//           </div>
//           <p className="text-4xl font-bold text-emerald-400 mb-2">$504,000</p>
//           <p className="text-gray-300">+12.3% this month</p>
//         </div>

//         <div className="bg-gradient-to-br from-blue-600/20 to-blue-800/20 border border-blue-500/30 rounded-xl p-6">
//           <h3 className="text-xl font-semibold text-white mb-4">Total Credits</h3>
//           <p className="text-4xl font-bold text-blue-400 mb-2">11,200</p>
//           <p className="text-gray-300">Across 4 projects</p>
//         </div>

//         <div className="bg-gradient-to-br from-purple-600/20 to-purple-800/20 border border-purple-500/30 rounded-xl p-6">
//           <h3 className="text-xl font-semibold text-white mb-4">Average Return</h3>
//           <p className="text-4xl font-bold text-purple-400 mb-2">10.7%</p>
//           <p className="text-gray-300">Annualized ROI</p>
//         </div>
//       </div>
...
//         <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6">
//           <h3 className="text-lg font-semibold text-white mb-6">Project Performance</h3>
...
//                   <p className="text-white font-semibold">${project.value.toLocaleString()}</p>
//                   <p className="text-emerald-400 text-sm">+{project.growth}%</p>
//                 </div>
//               </div>
//             ))}
//           </div>
...
//                   </td>
//                   <td className="py-4 px-4 text-right text-gray-300">${transaction.price}</td>
...
//               </p>
//               <p className="text-gray-400 text-sm">Target: {metric.target}{metric.unit}</p>
//             </div>
...
//       <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
//         <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6">
//           <h3 className="text-lg font-semibold text-white mb-6">Carbon Offset Impact</h3>
//           <ResponsiveContainer width="100%" height={300}>
...
//         <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6">
//           <h3 className="text-lg font-semibold text-white mb-6">Impact Distribution</h3>
//           <ResponsiveContainer width="100%" height={300}>
//             <RadarChart data={impactMetrics}>
//               <PolarGrid stroke="#374151" />
//               <PolarAngleAxis dataKey="category" tick={{ fontSize: 12, fill: '#9CA3AF' }} />
//               <PolarRadiusAxis angle={90} domain={[0, 100]} tick={false} />
//               <Radar name="Current" dataKey="value" stroke="#10b981" fill="#10b981" fillOpacity={0.3} />
//               <Radar name="Target" dataKey="target" stroke="#059669" fill="transparent" strokeDasharray="5 5" />
//             </RadarChart>
//           </ResponsiveContainer>
//         </div>
//       </div>
...
//       {cartItems.length === 0 ? (
//         <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-16 text-center">
//           <ShoppingCart className="h-16 w-16 text-gray-400 mx-auto mb-4" />
//           <h3 className="text-xl font-semibold text-white mb-2">Your cart is empty</h3>
//           <p className="text-gray-400 mb-6">Add some carbon credits to make a positive impact!</p>
//           <button 
...
//         <div className="space-y-4">
//           {cartItems.map((item) => (
//             <div key={item.id} className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6">
...
//                     <p className="text-emerald-400 font-semibold">${item.price} per credit</p>
//                   </div>
//                 </div>
...
//             Buyer Dashboard
//           </h1>
//           <p className="text-gray-400 mt-2">Invest in verified carbon credits and track your environmental impact</p>
//         </div>
...
//       <p className="text-sm font-medium">Carbon Investor</p>
...
//         <p className="text-sm font-medium">Carbon Investor</p>
//         <p className="text-xs text-gray-400">carbon@investor.com</p>
//       </div>
...
//         {activeTab === 'Watchlist' && (
//           <div className="space-y-8">
//             <h2 className="text-2xl font-bold text-white">Watchlist ({watchlist.length} items)</h2>
...
//             <span className="text-gray-400">Carbon Neutral Investments Since 2023</span>
//           </div>
//           <div className="flex space-x-6">
//             <span className="text-gray-400 text-sm">© 2024 Blue Carbon Marketplace</span>
...
//               <div>
//                 <h2 className="text-2xl font-bold text-white mb-2">{selectedCredit.project}</h2>
//                 <p className="text-gray-400">{selectedCredit.location}</p>
//               </div>
//               <button 
...
//               </div>
//               <div className="space-y-4">
//                 <h3 className="text-lg font-semibold text-white">Purchase Options</h3>
...
const BuyerDashboard = () => {
  ...
  const portfolioData = [
    { project: 'Mangrove', credits: 5000, value: 225000, growth: 12.5, color: '#0ea5e9' },
    { project: 'Seagrass', credits: 3200, value: 144000, growth: 8.3, color: '#3b82f6' },
    { project: 'Wetland', credits: 1800, value: 81000, growth: 15.2, color: '#6366f1' },
    { project: 'Kelp', credits: 1200, value: 54000, growth: 6.7, color: '#8b5cf6' }
  ];
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-gradient-to-r from-sky-600/20 to-indigo-600/20 rounded-xl p-6 border border-sky-500/30">
          ...
          <p className="text-3xl font-bold text-sky-400 mb-2">${(Object.values(realTimePrices)[0] || 48.75).toFixed(2)}</p>
          <p className="text-gray-300">Average Credit Price</p>
        </div>
        ...
        <div className="bg-gradient-to-r from-indigo-600/20 to-purple-600/20 rounded-xl p-6 border border-indigo-500/30">
          <h3 className="text-xl font-bold text-white mb-4">Market Sentiment</h3>
          <p className="text-3xl font-bold text-indigo-400 mb-2">Bullish</p>
          <p className="text-gray-300">+8.2% this week</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        {availableCredits.map((credit) => (
          <div key={credit.id} className="bg-black/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6 hover:bg-gray-900/70 transition-all duration-300 hover:scale-105 cursor-pointer group">
            <div className="flex justify-between items-start mb-4">
              <div className="flex-1">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  {credit.verified && <Shield className="h-4 w-4 text-sky-400" />}
                </div>
                <p className="text-gray-400 mb-2">{credit.location}</p>
                <div className="flex items-center space-x-4 text-sm text-gray-500">
                  <span className="flex items-center space-x-1">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-sky-600/10 rounded-lg p-3">
                <p className="text-sky-400 text-lg font-bold">${credit.price}</p>
                <p className="text-gray-400 text-xs">Per Credit</p>
              </div>
              <div className="bg-blue-600/10 rounded-lg p-3">
                <p className="text-blue-400 text-lg font-bold">{credit.available.toLocaleString()}</p>
            ...
            <div className="flex space-x-2">
              <button 
                onClick={() => setSelectedCredit(credit)}
                className="flex-1 flex items-center justify-center space-x-2 px-4 py-3 bg-gray-800 hover:bg-gray-700 text-white rounded-lg transition-colors"
              >
                <Eye className="h-4 w-4" />
                <span>View Details</span>
              </button>
              <button 
                onClick={() => addToCart(credit)}
                className="flex-1 flex items-center justify-center space-x-2 px-4 py-3 bg-sky-600 hover:bg-sky-700 text-white rounded-lg transition-colors"
              >
                <ShoppingCart className="h-4 w-4" />
                <span>Add to Cart</span>
              </button>
      ...
      <div className="bg-black/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <ComposedChart data={marketTrendData}>
            ...
            <Bar dataKey="volume" fill="#3b82f6" opacity={0.8} />
            <Line type="monotone" dataKey="price" stroke="#0ea5e9" strokeWidth={3} dot={{ fill: '#0ea5e9' }} />
          </ComposedChart>
        </ResponsiveContainer>
      </div>
    </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-sky-600/20 to-indigo-800/20 border border-sky-500/30 rounded-xl p-6">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-white">Portfolio Value</h3>
              <p className="text-sky-400">Real-time valuation</p>
            </div>
          </div>
          <p className="text-4xl font-bold text-sky-400 mb-2">$504,000</p>
          <p className="text-gray-300">+12.3% this month</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-indigo-600/20 to-purple-800/20 border border-indigo-500/30 rounded-xl p-6">
          <h3 className="text-xl font-semibold text-white mb-4">Average Return</h3>
          <p className="text-4xl font-bold text-indigo-400 mb-2">10.7%</p>
          <p className="text-gray-300">Annualized ROI</p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            {portfolioData.map((project, index) => (
              <div key={index} className="flex items-center justify-between p-4 bg-gray-900/30 rounded-lg">
                ...
                <div className="text-right">
                  <p className="text-white font-semibold">${project.value.toLocaleString()}</p>
                  <p className="text-sky-400 text-sm">+{project.growth}%</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="bg-black/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6">
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {transactionHistory.map((transaction) => (
                <tr key={transaction.id} className="border-b border-gray-800/50 hover:bg-gray-900/20 transition-colors">
                  <td className="py-4 px-4">
                    <p className="text-white font-medium">{transaction.project}</p>
                  </td>
                  <td className="py-4 px-4 text-gray-300">{transaction.date}</td>
        ...
        <div className="bg-black/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <RadarChart data={impactMetrics}>
              ...
              <PolarRadiusAxis angle={90} domain={[0, 100]} tick={false} />
              <Radar name="Current" dataKey="value" stroke="#0ea5e9" fill="#0ea5e9" fillOpacity={0.3} />
              <Radar name="Target" dataKey="target" stroke="#0284c7" fill="transparent" strokeDasharray="5 5" />
            </RadarChart>
          </ResponsiveContainer>
        </div>
      </div>
  ...
  const renderCart = () => (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          <span className="text-gray-400">{cartItems.length} items</span>
          <button className="bg-sky-500 hover:bg-sky-600 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-200">
            Checkout (${cartItems.reduce((total, item) => total + (item.price * item.quantity), 0).toLocaleString()})
          </button>
        </div>
      </div>
      ...
      {cartItems.length === 0 ? (
        <div className="bg-black/50 backdrop-blur-sm border border-gray-800 rounded-xl p-16 text-center">
          <ShoppingCart className="h-16 w-16 text-gray-400 mx-auto mb-4" />
          <h3 className="text-xl font-semibold text-white mb-2">Your cart is empty</h3>
          <p className="text-gray-400 mb-6">Add some carbon credits to make a positive impact!</p>
          <button 
        ...
        <div className="space-y-4">
          {cartItems.map((item) => (
            <div key={item.id} className="bg-black/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white">{item.project}</h3>
                    <p className="text-gray-400 text-sm">{item.location}</p>
                    <p className="text-sky-400 font-semibold">${item.price} per credit</p>
                  </div>
                </div>
                
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-2">
                    <button className="p-1 rounded bg-gray-800 hover:bg-gray-700">
                      <Minus className="h-4 w-4" />
                    </button>
                    <span className="text-white font-semibold w-8 text-center">{item.quantity}</span>
                    <button className="p-1 rounded bg-gray-800 hover:bg-gray-700">
