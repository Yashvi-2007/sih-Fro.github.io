...
export default function MapSection({ onShowMapFeatures = () => {} }) {
  ...
  return (
    <section id="global-impact" className="h-100 py-20 bg-black relative overflow-hidden">
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-70 bg-blue-500/5 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-70 bg-indigo-500/5 rounded-full blur-3xl"></div>
      ...
      {/* small decorative top line */}
      <div className="absolute left-0 right-0 top-0 h-px bg-gradient-to-r from-transparent via-blue-400 to-transparent" />
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-16 gap-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 mb-2">
            ...
            <span className="text-blue-400 text-sm font-medium">Global Projects</span>
          </div>
          
          <h2 className="text-4xl md:text-5xl font-bold text-white relative">
            Our <span className="bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Global Impact</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4">
            <button
              onClick={onShowMapFeatures}
              className="group inline-flex items-center gap-3 px-6 py-3 rounded-xl font-semibold shadow-lg transform transition-all duration-300 bg-gradient-to-r from-blue-500 to-indigo-500 text-white hover:shadow-2xl hover:gap-4"
            >
              <BarChart3 size={20} />
              <span>Advanced Features</span>
              <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
        ...
        {/* Filters Panel */}
        {showFilters && (
          <div className="bg-gray-800/50 backdrop-blur-md border border-blue-500/20 rounded-2xl p-6 mb-8 animate-fadeIn">
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-white mb-3">Project Type</h3>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="flex-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={searchQuery}
                    onChange={(e) => setSearchQuery(e.target.value)}
                    className="w-full pl-10 pr-4 py-3 bg-gray-700 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                  />
                </div>
              </div>
            </div>
        ...
        {/* map */}
        <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-blue-500/10 mb-16">
          ...
          >
            ...
            {filteredProjects.map((p) => (
              ...
              >
                <Popup>
                  <div className="w-72 bg-gray-900 border border-blue-500/20 rounded-xl p-4">
                    <span className={`inline-block px-3 py-1 text-xs rounded-full border ${typeBadgeColor(p.type)} font-medium`}>
                      {p.type.toUpperCase()}
                    </span>
                    <h4 className="text-blue-400 mt-3 font-bold text-lg">{p.name}</h4>
                    <div className="flex items-center gap-2 text-zinc-400 text-sm mt-2">
                      <MapPin className="w-4 h-4" />
                      <span>{p.location}</span>
                    </div>
                    ...
                    <p className="text-zinc-400 text-sm mt-3">{p.description}</p>
                    <button className="w-full mt-4 px-4 py-2 rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 font-semibold text-white hover:shadow-lg transition-shadow">
                      View Project Details
                    </button>
                  </div>
                </Popup>
        ...
        {/* stats */}
        <div ref={statsRef} className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-blue-500/10 rounded-2xl p-6 text-center backdrop-blur-sm transition-all duration-500 hover:border-blue-500/30">
            <div className="text-5xl font-black text-blue-400 mb-2">{projects.length}</div>
            <div className="text-zinc-400 text-lg">Active Projects</div>
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-blue-500/10 rounded-2xl p-6 text-center backdrop-blur-sm transition-all duration-500 hover:border-blue-500/30">
            <div className="text-5xl font-black text-blue-400 mb-2">18,500+</div>
            <div className="text-zinc-400 text-lg">Tons CO₂ Reduced Yearly</div>
          </div>
        </div>
      </div>
